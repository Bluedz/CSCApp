...
export class PurchaseTrackComponent {
    ...
    getPurchaseList() {
        ...
        //:-
        if (_this.filters.approveDate) {
            filter += '&approveDate=' + _this.filters.approveDate;
        }
        if (_this.filters.approveDateStart) {
            filter += '&approveDateStart=' + _this.filters.approveDateStart;
        }
        if (_this.filters.approveDateEnd) {
            filter += '&approveDateEnd=' + _this.filters.approveDateEnd;
        }
        //-:
        if(this.plant!="全部"){
